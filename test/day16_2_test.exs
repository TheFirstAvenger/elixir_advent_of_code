defmodule AdventOfCode.Day16_2Test do
  use ExUnit.Case
  alias AdventOfCode.Day16_2

  test "final test" do
    aunts = "Sue 1: goldfish: 6, trees: 9, akitas: 0
...
perfumes: 1"
    ...
    assert 405 = Day16_2.handle_input(aunts, mfcsam_output)
  end
end
